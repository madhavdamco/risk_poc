      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <div className="relative">
          ...
          <div
            ...
            className="absolute right-16 top-1/2 -translate-y-1/2 cursor-pointer flex h-5 w-5 items-center justify-center rounded border-2 transition-colors hover:border-primary"
            style={{
